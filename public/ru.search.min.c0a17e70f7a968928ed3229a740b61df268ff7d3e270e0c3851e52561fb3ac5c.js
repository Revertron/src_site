...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ru.search-data.min.4333ee472f3746e1326e14a3483723a3fdd5fc31acd235141f448c90a9add92a.js',function(){input.required=false;search();});}
