...
На али и ебее продаются внутренние корзины для хардов (HDD Cage Rack), которые можно закрепить внутри системника, и на которые можно повесить кулер. Например, такая хуйня: ![HDD Cage Rack](/pic/NEW-5-25-to-5x-3-5-SATA-SAS-HDD-Cage-Rack-Hard-Drive-Tray-Caddy.jpg_640x640.jpg)
...
![zfs layers](pic/zfs-overview.png)
- VDev:
